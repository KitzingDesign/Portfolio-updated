    ...
    <div className={styles.container}>
      ...
      <section data-aos="fade-up">
        <p>
          ...
          collaboration with the company Boid. Currently, Vargön has four
          control rooms, one for each furnace. The goal of the project was to
          consolidate these four control rooms into one large, shared control
          room, enabling remote control of the furnaces. <br />
          <br />
          ...
          involved in the project, responsible for creating the automation
          system for the furnace itself.
          <br />
          ...
          This demanded an open-minded and flexible approach to ensure the
          optimal functioning of the new control room as a whole. Below, the
          different phases of the work are briefly outlined.
        </p>
      </section>
